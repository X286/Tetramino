...
class BuildExe:
    def __init__(self):
        ...
        self.author_email = "stuckinmypopper@gmail.com"
    ...
    def run(self):
        ...
        setup(
            ...
            options = {'py2exe': {'optimize': 2, 'bundle_files': 1, 'compressed': True, \
                                  'excludes': [self.exclude_modules, 'Tkconstants', 'Tkinter'], 'packages': self.extra_modules, \
